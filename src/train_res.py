...
from src.models.resunet import ResUNet   # <-- change to your actual import path
...
def train():
    ...
    ckpt_dir = Path("checkpoints/resunet")
    ckpt_dir.mkdir(parents=True, exist_ok=True)

    # Keep transforms identical to UNet training for fairness
    ...
    # ---- Model swap only ----
    # Adjust constructor args to match your ResUNet implementation
    ...
    logger = MetricLogger("outputs/metrics/resunet_metrics.csv")
